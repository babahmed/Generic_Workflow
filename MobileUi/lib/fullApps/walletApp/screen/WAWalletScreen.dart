        ...
        appBar: AppBar(
          ...
          actions: [
            Container(
              ...
              child: waCommonCachedNetworkImage('images/walletApp/wa_add_icon.png', fit: BoxFit.fill),
            ),
          ],
        ),
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                30.height,
                Align(alignment: Alignment.topLeft, child: Text('Send Money to', style: boldTextStyle(size: 20))).paddingLeft(16),
                16.height,
                WAWalletUserListComponent(walletUserList: walletUserList),
                16.height,
                Align(alignment: Alignment.topLeft, child: Text('Transactions', style: boldTextStyle(size: 20))).paddingLeft(16),
                16.height,
                Column(
