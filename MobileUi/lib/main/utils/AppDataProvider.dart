...
List<ProTheme> getScreenList() {
  ...
  list.add(ProTheme(name: 'Pricing Plans', title_name: 'Pricing Plan Screens', tag: 'New', show_cover: true, sub_kits: getPricingPlans(), darkThemeSupported: true));
...
List<ProTheme> getMaterialWidgets() {
  List<ProTheme> list = [];
  list.add(ProTheme(name: 'App Structure', show_cover: false, type: '', sub_kits: getAppStructure(), darkThemeSupported: true, isWebSupported: true));
  ...
  list.add(ProTheme(name: 'Dialogs, Alerts & Panels', show_cover: false, type: '', sub_kits: getDialogs(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'Information Display', show_cover: false, type: '', sub_kits: getInformationDisplay(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getAppStructure() {
  ...
  list.add(ProTheme(name: 'Bottom Navigation Bar', show_cover: false, type: '', sub_kits: getBottomNavigationBar(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'Drawer', show_cover: false, type: '', sub_kits: getDrawer(), darkThemeSupported: true, isWebSupported: true));
  ...
  list.add(ProTheme(name: 'TabBar', show_cover: false, type: '', sub_kits: getTabBar(), darkThemeSupported: true, isWebSupported: true));
  return list;
}
...
List<ProTheme> getDialogs() {
  ...
  list.add(ProTheme(name: 'BottomSheet', show_cover: false, type: '', widget: MWBottomSheetScreen(), darkThemeSupported: true, isWebSupported: true));
  list.add(ProTheme(name: 'ExpansionPanel', show_cover: false, type: '', widget: MWExpansionPanelScreen(), darkThemeSupported: true, isWebSupported: true));
...
List<ProTheme> getInformationDisplay() {
  ...
  list.add(ProTheme(name: 'Card', show_cover: false, type: '', widget: MWCardScreen(), darkThemeSupported: true, isWebSupported: true));
